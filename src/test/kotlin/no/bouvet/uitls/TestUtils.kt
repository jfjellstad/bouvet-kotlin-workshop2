...
import no.bouvet.challenge03.Stock
import no.bouvet.challenge03.StockRepository
...
suspend fun StockRepository.prepareTestData(): List<Stock> {
    deleteAll()
